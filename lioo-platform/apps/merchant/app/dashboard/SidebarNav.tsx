  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 z-50 bg-[#F3F4EF] flex flex-col py-8 px-4 border-r-0 transition-all duration-300">
      ...
      <div className="mt-auto pt-6 space-y-1">
        ...
        <LogoutLink postLogoutRedirectURL="http://localhost:3001" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:text-error hover:bg-error-container/50 text-[#43493E] font-medium transition-all w-full text-left">
