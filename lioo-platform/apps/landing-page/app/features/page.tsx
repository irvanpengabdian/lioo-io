    ...
    <nav className="fixed top-0 w-full z-50 bg-[#F9FAF5]/80 backdrop-blur-xl border-b border-[#C3C9BA]/20">
      <div className="flex justify-between items-center px-6 lg:px-10 py-4 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`${process.env.NEXT_PUBLIC_MERCHANT_URL || "http://localhost:3002"}/api/auth/register`} className="text-white px-6 py-2.5 rounded-full font-bold text-sm shadow-md hover:opacity-90 active:scale-95 transition-all" style={{ background: "linear-gradient(145deg,#436831,#2C4F1B)" }}>
            Mulai Menyemai
          </Link>
        </div>
      </div>
      ...
      <main className="pt-28 pb-24" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", backgroundColor: "#F9FAF5" }}>
        ...
        <section className="max-w-3xl mx-auto px-6 text-center mt-28">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href={`${process.env.NEXT_PUBLIC_MERCHANT_URL || "http://localhost:3002"}/api/auth/register`} className="text-white px-10 py-4 rounded-full font-extrabold text-lg shadow-xl hover:scale-105 active:scale-95 transition-all" style={{ background: "linear-gradient(145deg,#436831,#2C4F1B)" }}>
              🌱 Mulai Menyemai
            </Link>
