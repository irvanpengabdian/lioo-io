          ...
          <div className="relative rounded-[3rem] overflow-hidden p-12 md:p-24 text-center" style={{ background: "linear-gradient(145deg,#436831,#2C4F1B)" }}>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link href={`${process.env.NEXT_PUBLIC_MERCHANT_URL || "http://localhost:3002"}/api/auth/register`} className="bg-white text-[#2C4F1B] px-10 py-4 rounded-full font-extrabold text-lg hover:shadow-xl transition-all active:scale-95">
                  🌱 Mulai Menyemai
                </Link>
